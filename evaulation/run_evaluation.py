...
if __name__ == "__main__":
    ...
    for i, item in enumerate(questions):
        ...
        if question in cache:
            ...
            rag_response = rag_evaluator.get_rag_response(question, rag_corpus_path, generation_model, config['num_context_chunks'])
        ...
        logging.info(f"--- Pausing for {config['rate_limit_delay']} seconds to respect API rate limits ---")
